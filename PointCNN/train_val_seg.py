...
def main():
    ...
    print("Lancement code Apprentissage")
    
    # Prepare inputs
    print('{}-Preparing datasets...'.format(datetime.now()))
    is_list_of_h5_list = not data_utils.is_h5_list(args.filelist)
    
    print('is_list_of_h5_list : ', is_list_of_h5_list)
    ...
    if setting.data_dim > 3:
        ...
        #print("Data_dim = ", setting.data_dim)
        #print("ligne 132")
    ...
    with tf.Session() as sess:
        ...
        for batch_idx_train in range(batch_num):
            ...
            #print("sample_num_train : ", sample_num_train)
            #print("points_num_batch : ", points_num_batch)
