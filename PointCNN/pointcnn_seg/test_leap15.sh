...
CUDA_VISIBLE_DEVICES=$gpu python ../test_leap_seg.py -f ../../data/LEAP_seg/Test.txt -c ../../data/LEAP_seg/categories.txt -d ../../data/LEAP_seg/Test_15/Files_data -l $ckpt -m pointcnn_seg -x $setting -r $repeat $save_ply > ../../models/seg/LEAP/pointcnn_seg_inference_test15_$setting.txt 2>&1 &