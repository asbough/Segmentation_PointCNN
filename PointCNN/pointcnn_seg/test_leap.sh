...
CUDA_VISIBLE_DEVICES=$gpu python ../test_leap_seg.py -f ../../data/LEAP_seg/Test.txt -c ../../data/LEAP_seg/categories_synth.txt -d ../../data/LEAP_seg/Test/Files_data -l $ckpt -m pointcnn_seg -x $setting -r $repeat $save_ply > ../../models/seg/LEAP/pointcnn_seg_inference_$setting.txt 2>&1 &