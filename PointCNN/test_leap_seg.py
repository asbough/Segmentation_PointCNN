...
def main():
    ...
    output_folder = args.data_folder + '_pred_leap_' + str(args.repeat_num)
    ...
    with tf.Session() as sess:
        ...
        for batch_idx in range(batch_num):
            ...
            print("type : ", type(object_label))
            #ajout
            if type(object_label)!=int:
            ...
            print("len : ", len(category_list))
            print("object label : ", object_label)
            point_num = data_num[batch_idx]
            
            #if type(point_num)!=int:
             #   point_num = point_num[0]
                
            #on récupère la clé de la catégorie
            #category = category_list[object_label][0]
            category = "Classe"+str(object_label)
            ...
            #print("indice_batch : ", indices_batch)
